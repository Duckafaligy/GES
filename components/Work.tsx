...
const PROJECTS: Project[] = [
  {
    ...
    price: 3200,
    breakdown: [
      { item: "Design system & brand styling", cost: 350 },
      { item: "Responsive front-end build", cost: 450 },
      { item: "Cinematic 3D product hero", cost: 700 },
      { item: "Interactive device showcase", cost: 350 },
      { item: "Scroll-driven animation", cost: 300 },
      { item: "Product pages (×6)", cost: 350 },
      { item: "Cart & pre-order flow", cost: 350 },
      { item: "Mobile optimization & QA", cost: 200 },
      { item: "SEO + performance tuning", cost: 150 },
    ],
  },
  {
    ...
    price: 2200,
    breakdown: [
      { item: "Design & layout system", cost: 300 },
      { item: "Responsive front-end build", cost: 350 },
      { item: "Core platform pages", cost: 350 },
      { item: "Multilingual content setup", cost: 250 },
      { item: "Sign-up & onboarding flow", cost: 300 },
      { item: "Extra content pages (×8)", cost: 250 },
      { item: "Mobile optimization", cost: 200 },
      { item: "SEO + analytics setup", cost: 200 },
    ],
  },
  {
    name: "LaunchVault",
    ...
    price: 6500,
    breakdown: [
      { item: "Design system & UI kit", cost: 700 },
      { item: "Responsive marketing site", cost: 600 },
      { item: "User accounts & auth", cost: 800 },
      { item: "Stripe subscriptions & billing", cost: 800 },
      { item: "Dynamic content engine (ranked feed)", cost: 1400 },
      { item: "50-domain taxonomy & tagging", cost: 600 },
      { item: "Pricing / Stories / onboarding", cost: 600 },
      { item: "Admin / content dashboard", cost: 500 },
      { item: "Performance, SEO & QA", cost: 500 },
    ],
  },
];
