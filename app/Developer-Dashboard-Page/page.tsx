    ...
    <div>
      ...
      <div className="max-w-5xl mx-auto px-5 py-8">
        ...
        <div className="flex gap-2 mb-8">
          ...
          <button onClick={() => setTab("clients")} className={`mono text-xs uppercase tracking-[0.14em] px-4 py-2 border-2 border-[var(--line)] ${tab === "clients" ? "bg-[var(--acid)] text-[#0a0a0a]" : "hover:bg-white/10"}`}>Clients &amp; bookings</button>
        </div>
