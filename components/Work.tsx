...
const PROJECTS: Project[] = [
  {
    ...
    price: 1500,
    breakdown: [
      { item: "Design system & brand styling", cost: 150 },
      { item: "Responsive front-end build", cost: 250 },
      { item: "Cinematic 3D product hero", cost: 300 },
      { item: "Interactive device showcase", cost: 150 },
      { item: "Scroll-driven animation", cost: 150 },
      { item: "Product pages (×6)", cost: 200 },
      { item: "Cart & pre-order flow", cost: 150 },
      { item: "Mobile optimization & QA", cost: 100 },
      { item: "SEO + performance tuning", cost: 50 },
    ],
  },
  {
    ...
    price: 1000,
    breakdown: [
      { item: "Design & layout system", cost: 125 },
      { item: "Responsive front-end build", cost: 175 },
      { item: "Core platform pages", cost: 175 },
      { item: "Multilingual content setup", cost: 100 },
      { item: "Sign-up & onboarding flow", cost: 150 },
      { item: "Extra content pages (×8)", cost: 125 },
      { item: "Mobile optimization", cost: 75 },
      { item: "SEO + analytics setup", cost: 75 },
    ],
  },
  {
    name: "LaunchVault",
    ...
    price: 3000,
    breakdown: [
      { item: "Design system & UI kit", cost: 300 },
      { item: "Responsive marketing site", cost: 250 },
      { item: "User accounts & auth", cost: 400 },
      { item: "Stripe subscriptions & billing", cost: 400 },
      { item: "Dynamic content engine (ranked feed)", cost: 600 },
      { item: "50-domain taxonomy & tagging", cost: 300 },
      { item: "Pricing / Stories / onboarding", cost: 250 },
      { item: "Admin / content dashboard", cost: 250 },
      { item: "Performance, SEO & QA", cost: 250 },
    ],
  },
];
